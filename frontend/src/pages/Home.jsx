...
// FIX: Added 'Film' to the imports
import { Play, Star, TrendingUp, Download, Sparkles, Film } from "lucide-react";
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                <Link
                  to="/series"
                  className="inline-flex items-center gap-2 bg-gray-800/50 backdrop-blur-sm px-8 py-3 rounded-full font-bold text-lg border border-gray-700 hover:bg-gray-700/50 transition"
                >
